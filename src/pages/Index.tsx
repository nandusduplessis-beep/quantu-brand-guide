...
import { Copy, Sparkles, Megaphone, FileText, Film } from "lucide-react";
      ...
      <main className="container mx-auto px-4 sm:px-6 lg:px-8 py-8 md:py-12">
        ...
        <section className="text-center mb-16 animate-fade-in">
          ...
          <p className="text-sm text-muted-foreground mt-3">
            Create a campaign, generate a white paper, explore motion graphics, or copy brand guidelines to paste into Lovable
          </p>
        </section>
